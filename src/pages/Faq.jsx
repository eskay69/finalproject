          ...
          <div className="container bg-white rounded-3xl py-4 border-4 border-white md:px-8 text-center">
            ...
            <div className="p-4">
              ...
              <div>
                <div className="md:p-6 text-colour3">
                  ...
                  <div>
                    <p className="p-4 mb-8 text-xl">
                      <p className="font-black py-2">
                        PS: To ensure you don't forget, I can personally remind you through my whatsapp community when the webinar starts. If you would like this, click the                      
                ...
                <CasualButton
                  textWord="Click Here to Get a Reminder"
                  buttonColor="colour3"
                  textColor="white"
